//! `a2a_get_task` — poll a Task on a registered A2A peer.
...
use crate::mcp::server::A2aGetTaskParams;
use crate::mcp::tools::sota_helpers::{json_result, pool_or_err};

pub async fn tool_a2a_get_task(
    ctx: &SystemContext,
    params: A2aGetTaskParams,
) -> Result<CallToolResult, McpError> {
    tracing::debug!(tool = "a2a_get_task", "MCP tool invoked");
