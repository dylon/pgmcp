...
//!
//! Louvain lives in `algorithms/louvain.rs` (extracted as part of the D.2
//! god-file split); the rest stays here. Future extracts follow the same
//! pattern: declare a sibling `mod` and `pub use` what was previously inline.
